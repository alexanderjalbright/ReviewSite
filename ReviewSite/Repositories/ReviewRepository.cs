    ...
    public class ReviewRepository
    {
        ...
        public ReviewRepository()
        {
            reviewList = new List<Review>()
            {
                ...
                new Review("WWKD", 3, "C#", "./images/WWKD.jpg", "It definitely not for everybody!", "Some people can!", new List<string>() { "The instructors love you like their own family!", "If I could experience Groundhog Day here, I'd still never get enough.", "This place attracts weirdos." })
            };
        } 
